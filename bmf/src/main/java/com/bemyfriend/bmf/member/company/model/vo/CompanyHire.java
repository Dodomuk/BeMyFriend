...
public class CompanyHire {
	...
	public CompanyHire(int jobNo, String comId, String jobTitle, Date jobDeadline, String jobStep, String jobType,
			...
			String jobPreper, String jobWelfare, String jobSalary, Date jobDate, String jobImage) {
		super();
		this.jobNo = jobNo;
		this.comId = comId;
	...
	public String toString() {
		return "CompanyHire [jobNo=" + jobNo + ", comId=" + comId + ", jobTitle=" + jobTitle + ", jobDeadline="
				...
				+ ", jobSalary=" + jobSalary + ", jobDate=" + jobDate + ", jobImage=" + jobImage + "]";
	}
