...
<body>
    ...
    <div class="">
      <div class="">
	<div class="tabArea">
		<ul class="nav nav-pills nav-fill" aria-current="page" style="padding: 0 10% 0 10%; width:100%; justify-content:center;">
			<li class="nav-item"><a href="#"> <span class="tx">
						전체 </span>
			</a></li>
			<li class="nav-item"><a href="#"> <span class="tx"> 취업/면접 </span>
			</a></li>
			<li class="nav-item"><a href="#"> <span class="tx"> 매체 정보 </span>
			</a></li>
			<li class="nav-item"><a href="#"> <span class="tx"> 법률 자료 </span>
			</a></li>
			<li class="nav-item"><a href="#"> <span class="tx"> QNA </span>
			</a></li>
