 ...
 <section class="hero-wrap hero-wrap-2" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="${context}/main">Community <i class="ion-ios-arrow-forward"></i></a></span> <span>REVIEW <i class="ion-ios-arrow-forward"></i></span></p>
	...
	<ul class="nav nav-tabs">
		<li class="nav-item"><a class="nav-link active"
			href="${context}/community/review/review">기업 리뷰</a></li>
		<li class="nav-item"><a class="nav-link"
			href="${context}/community/law">법률</a></li>
		<li class="nav-item"><a class="nav-link"
			href="${context}/community/media">매체</a></li>
		<li class="nav-item"><a class="nav-link"
			href="${context}/community/qna">QNA</a></li>
	</ul>
	<!-- 커뮤니티 nav 끝 -->
                       ...
                       <c:set var="i" value="${i+1}"/>
							<div class="item">
								<div class="testimony-wrap py-4">
									...
									<a href="${context}/community/review/reviewView?view=${reviewtl.reviewNo}"
			...
			<div class="row mb-5 pb-10">
				...
				<c:if test="${!empty reviewList}">
					<c:forEach items="${reviewList}" var="review">
						<c:set var="reviewdate">
							<fmt:formatDate value="${review.reviewDate}" pattern="yyyy.MM.dd" />
						</c:set>
						<div
							class="col-md-3 pb-5 d-flex align-self-stretch px-3 ftco-animate">
							<div class="d-block services text-center">
								<div class="media-body p-3">
									...
									<span class="position"> ${reviewdate} </span>
									<p></p>
									<a href="${context}/community/review/reviewView?view=${review.reviewNo}"
										class="btn-custom d-flex align-items-center justify-content-center"><span
										class="fa fa-chevron-right"></span><i class="sr-only">Read
											more</i></a> <span></span>
								</div>
		...
		<div class="container">
			<div class="row mt-5">
				<div class="col text-center">
					<div class="block-27">
						<ul>
							<li><a href="${context}/community/review/review"
								class="nav first">《</a></li>
							<li><a
								href="${context}/community/review/review?page=${paging.prev}">&lt;</a></li>
							...
							<li><a
								href="${context}/community/review/review?page=${paging.next}">&gt;</a></li>
							<li><a
								href="${context}/community/review/review?page=${paging.lastPage}">》</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<c:choose>
	<c:when
		test="${(userMember.userId == null) && (comMember.comId == null)}">
		<script>
