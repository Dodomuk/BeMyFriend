		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">리뷰 작성</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				...
				<div class="row no-gutters">
					<div class="col-md-7-p">
						<div class="contact-wrap w-100 p-md-5 p-4">
							...
							<div class="content">
								<form action="${context}/community/review/uploadForm"
									method="post" class="form-group">
									<div class="row">
										<div class="col-md-8">
											<label class="label">제목</label><input class="form-control"
												name="reviewTitle" required="required" />
										</div>
										<div class="col-md-12">
										...
										<div>
											...
											<div class="form-group">
											    <div></div>
												<label class="label"><strong>작성자</strong>: ${memberName} / ${memberId}</label>
											</div>
											</div>
										</div>
										<div class="col-md-12">
