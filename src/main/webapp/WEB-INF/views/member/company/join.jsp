												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" for="status">기업형태</label><br>
															<input type="radio" class ="status" name="status" id="start"> 스타트업<br>
															<input type="radio" class ="status" name="status" id="small"> 중소기업<br>
															<input type="radio" class ="status" name="status" id="middle"> 중견기업<br>
															<input type="radio" class ="status" name="status" id="big"> 대기업				
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
