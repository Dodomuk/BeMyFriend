...
<body>
			...
			<div class="row search_row">
				...
				<div class="col-lg-8 sidebar pl-lg-5 ftco-animate">
					<div class="sidebar-box">
						<form
							action="${context}/search/searchdeep?searchType=${searchType.value}&keyword=${keyword.value}"
	...
	<section class="ftco-section bg-light">
		<c:if test="${comMember != null}">
			<section class="btn_body">
				<div class="button_container">
					<button class="btn_gongo"
						onclick="location.href='${context}/recruitment/recruitmentForm';">
						<span>공고작성</span>
					</button>
				</div>
			</section>
		...
		<div class="container" style="padding-top: 15px;">
				<div class="row">
					...
					<c:forEach items="${recruList}" var="recru">
						...
						<div class="col-md-6 col-lg-3 ftco-animate"  onClick="location.href='/recruitment/recruitmentView?view=${recru.typeIdx}'">
							<div class="staff">
								<div class="img-wrap d-flex align-items-stretch">
									<div class="img align-self-stretch"><!-- <img src=""> --></div>
								</div>
