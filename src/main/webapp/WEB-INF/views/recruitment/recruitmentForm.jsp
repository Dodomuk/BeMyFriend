							...
							<div class="row no-gutters">
								<div class="col-md-7-p">
									<div class="contact-wrap w-100 p-md-5 p-4">
										...
										<form:form modelAttribute="recruitment" action="${context}/recruitment/uploadForm" method="POST"  id="recruForm" name="recruForm" class="recruForm" enctype="multipart/form-data">
											<div class="row">
												<div class="col-md-6">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="label">공고 제목</label>
														<input type="text" class="form-control" name="jobTitle" id="jobTitle" required="required" >
													</div>
												</div>
												...
												<div class="col-md-6"> 
													<div class="form-group">
														...
														<input type="date" class="form-control" name="jobDeadline" id="jodDeadline" required="required">
                                                   	</div>
												</div>
												
												<div class="col-md-6"> 
													<div class="form-group">
                                                 <label class="label" id="step_title">전형 절차</label>
													<input type="text" class="form-control" name="jobStep" id="jobStep" required="required" >
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" >채용형태</label>
                                                           <input type="text" class="form-control" name="jobType" id="jobType" required="required">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" >채용인원</label>
														<br>
                                                     <input type="radio" id="check_num" name="jobPerNum" value="0명">
                                                        <label for="male">0명</label><br>
                                                     <input type="radio" id="check_num" name="jobPerNum" value="00명">
                                                        <label for="female">00명</label><br>
                                                     <input type="radio" id="check_num" name="jobPerNum" value="000명">
                                                        <label for="other">000명</label><br><br>                                                   
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" >담당업무</label>
                                                           <input type="text" class="form-control" name="jobDuty" id="jobDuty" required="required">
													</div>
												</div>												
												<div class="col-md-6">
													<div class="form-group">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" >채용경력</label>
														<input type="text" class="form-control" name="jobCareer" id="jobCareer" required="required">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" >채용학력</label>
														<input type="text" class="form-control" name="jobEdu" id="jobEdu" required="required">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" >필수요건</label>
														<input type="text" class="form-control" name="jobNeed" id="jobNeed" required="required">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" >우대요건</label>
														<input type="text" class="form-control" name="jobPreper" id="jobPreper" required="required">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" >복리후생</label>
														<input type="text" class="form-control" name="jobWelfare" id="jobWelfare" required="required">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" >채용급여</label>
														<input type="text" class="form-control" name="jobSalary" id="jobSalary" required="required">
													</div>
												</div>		
												<div class="col-md-12">
													<div class="form-group">
												...
												<div class="col-md-12">
													<div class="form-group-log-p">
									                    ...
									                    <button type="submit" class="btn btn-primary" onclick="alert('등록되었습니다!')">등록</button>
