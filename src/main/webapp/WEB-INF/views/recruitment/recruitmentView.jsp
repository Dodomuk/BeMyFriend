...
<meta name="viewport"
  ...
  <body>
    ...
    <!-- END nav -->
    <!-- 공고 메인 -->
   							<div class="row no-gutters" id="jobInfoBox" style="align-items: center;">
								<div class="col-md-8 col-md-offset-4">
									<div class="contact-wrap w-100 p-md-5 p-4">
									    <h3>${view.comId}</h3>
										<h1 class="mb-4">${view.jobTitle}</h1>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<div>
														<label class="label col-sm-4">경력</label>
													    <label class="col-sm-6">${view.jobCareer}</label>
													    </div>
													    <div>
														<label class="label col-sm-4">학력</label>
													    <label class="col-sm-6">${view.jobNeed}</label>
													    </div>
													    <div>
														<label class="label col-sm-4">우대조건</label>
													    <label class="col-sm-6">${view.jobPreper}</label>
													    </div>
													</div>
												</div>
												<div class="col-md-6"> 
													...
													<div>
														<label class="label col-sm-4">고용 형태</label>
														<label class="col-sm-6">${view.jobType}</label>
														</div>	
													<div>
														<label class="label col-sm-4">급여</label>
														<label class="col-sm-6">${view.jobSalary}</label>
														</div>	
													<div>
														<label class="label col-sm-4">지역</label>
														<label class="col-sm-6">${view.jobLocation}</label>
														</div>	
														</div>	
												</div>
												<div class="col-md-8 col-md-offset-4">
